    ...
    <>
      <div className="container about-page">
        <div className="text-zone">
          ...
          <p>
            If I need to define myself in one sentence that would be highly motivated
            hard worker, book worm, man of the sea, extreme sports fanatic,
            piano and japanese language lover, and code obsessed!!!
          </p>
        </div>
